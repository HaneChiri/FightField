 ...
 *
 */
public class Grappler extends Characters {

	public static final String APPEARANCE_L_PATH="image\\Characters\\Grappler\\Grappler_L.png";
	public static final String APPEARANCE_R_PATH="image\\Characters\\Grappler\\Grappler_R.png";
	public static final String APPEARANCE_DEATH_PATH="image\\Characters\\grave.png";
	
	public Grappler(String _name,int _hitPoint,int _magicPoint,int _damage,int _defense,WeaponBehavior[] ws,MagicBehavior[] ms) {
